    ...
    <>
      <nav className="nav">
        <div className="nav__wrapper">
          <h1 className="home-logo">📚 Summarist</h1>

          <ul className="nav__list--wrapper">
            <li className="nav__list" onClick={() => setShowModal(true)}>Login</li>
          ...
          <div className="row">
            <div className="landing__wrapper">
              <div className="landing__content">
                ...
                <button className="btn home__cta--btn" onClick={() => setShowModal(true)}>
                  Login
                </button>
              </div>
        ...
        <div className="row">
          <div className="container">
            ...
            <div className="reviews__wrapper">
              {["Hanna M.", "David B.", "Nathan S.", "Ryan R."].map((name) => (
          ...
          <div className="row">
            <div className="footer__top--wrapper">
              {[
                ...
                <div className="footer__block" key={block[0]}>
                  <div className="footer__link--title">{block[0]}</div>
                  {block.slice(1).map((link) => (
